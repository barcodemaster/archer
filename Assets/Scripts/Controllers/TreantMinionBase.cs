...
/// <summary>
/// 점프 후 착지 시 투사체를 발사하는 트리언트 미니언 계열 몬스터의 공통 베이스 클래스.
/// </summary>
[RequireComponent(typeof(TilePassability))]
public abstract class TreantMinionBase : MonsterBase
{
	...
	[SerializeField] protected float _projectileDamage = 15f;
	...
	/// <summary>
	/// 포물선 궤적으로 점프 위치를 갱신하고, 착지 시 투사체 발사를 시작한다.
	/// </summary>
